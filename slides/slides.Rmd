---
title: "Machine learning, Deep Learning, and (R|Python)"
author: |
  | Mark Andrews
...
* Put very informally, machine learning is a means to engineer knowledge or behaviour into a computer or machine by providing examples rather than explicit programming.
...
* Artificial neural nets were a side-show in machine learning until around 2010. Since then, they've been widely celebrated (and hyped?).
...
* But is R just as powerful and extensive for machine learning research, or the use of machine learning tools in scientific data analysis? Probably.
